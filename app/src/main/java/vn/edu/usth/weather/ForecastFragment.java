...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v.setBackgroundColor(Color.parseColor("#F7E79F"));

        LinearLayout ll = new LinearLayout(this.getContext());
        ll.setOrientation(LinearLayout.VERTICAL);

//        TextView monday = new TextView(getActivity());
//        monday.setText("Monday is a rainy day =(((");
...
//        sunday.setText("Sunday is a sunny day =)))");
//        ImageView sunny = new ImageView(getActivity());
//        rainy.setImageResource(R.drawable.sunny);
//
//        ll.addView(sunday);
//        ll.addView(sunny);
